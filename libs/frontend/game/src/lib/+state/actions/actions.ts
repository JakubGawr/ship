...
export const BoardActions = {
  ...
  addCord: createAction('[Board] Add Cord', props<{ cords: Cords }>()),
  addCordSuccess: createAction('[Board] Add Cord Success', props<{ cords: Cords }>()),
  addCordFail: createAction('[Board] Add Cord Fail')
};
